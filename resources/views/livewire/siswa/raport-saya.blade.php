<div>
    <x-layout.page-header title="Raport Digital" subtitle="Lihat hasil belajar Anda per tahun ajaran">
        <x-slot:actions>
            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-sm table-borderless mb-0">
                        <tr><td width="150" class="text-muted">Nama Siswa</td><td>: <span style="color: var(--text-primary); font-weight: 600;">{{ Auth::guard('siswa')->user()->nama_siswa }}</span></td></tr>
                        <tr><td class="text-muted">NISN</td><td>: <span style="color: var(--text-primary);">{{ Auth::guard('siswa')->user()->nisn }}</span></td></tr>
    ...
    @else
        <x-layout.modern-card>
            <x-ui.empty-state 
                ...
                description="Raport digital untuk tahun ajaran yang dipilih belum diterbitkan atau Anda belum memiliki raport." 
            />
        </x-layout.modern-card>
    @endif
</div>
