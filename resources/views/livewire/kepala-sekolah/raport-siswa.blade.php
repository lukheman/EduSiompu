<div>
    <x-layout.page-header title="Raport Siswa" subtitle="Lihat raport digital seluruh siswa per kelas dan tahun ajaran">
        <x-slot:actions>
            <div class="d-flex gap-2">
                ...
                <div style="width: 220px;">
                    <x-form.select
                        ...
                        id="tahun"
                        :options="collect($tahunAjarans)->mapWithKeys(fn($ta) => [$ta->id_tahun_ajaran => $ta->nama_tahun . ' ' . ucfirst($ta->semester)])->toArray()"
            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-sm table-borderless mb-0">
                        <tr><td width="150" class="text-muted">Nama Siswa</td><td>: <span style="color: var(--text-primary); font-weight: 600;">{{ $raport->siswa->nama_siswa }}</span></td></tr>
    ...
    @else
        <x-layout.modern-card>
            <x-ui.empty-state
                ...
                description="Pilih kelas, siswa, dan tahun ajaran untuk melihat raport digital."
            />
        </x-layout.modern-card>
    @endif
</div>
